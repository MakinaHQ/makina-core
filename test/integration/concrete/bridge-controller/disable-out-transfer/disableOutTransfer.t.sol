...
abstract contract DisableOutTransfer_Integration_Concrete_Test is BridgeController_Integration_Concrete_Test {
    ...
    function test_RevertWhen_AlreadyDisabled() public {
    ...
    function test_DisableOutTransfer() public {
        address bridgeAdapter = makeAddr("bridgeAdapter");
        ...
        emit IBridgeController.OutTransferDisabled(ACROSS_V3_BRIDGE_ID);
        vm.prank(riskManagerTimelock);
        bridgeController.disableOutTransfer(ACROSS_V3_BRIDGE_ID);
