...
library ChainsInfo {
    ...
    function getChainInfo(uint256 chainId) internal pure returns (ChainInfo memory) {
        if (chainId == CHAIN_ID_ETHEREUM) {
            ...
            return ChainInfo({
                evmChainId: CHAIN_ID_SEPOLIA,
                wormholeChainId: WormholeChains.CHAIN_ID_SEPOLIA,
                name: "Sepolia",
            ...
            return ChainInfo({
                evmChainId: CHAIN_ID_BASE_SEPOLIA,
                wormholeChainId: WormholeChains.CHAIN_ID_BASE_SEPOLIA,
                name: "Base Sepolia",
