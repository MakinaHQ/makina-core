...
abstract contract LayerZeroV2Config_Unit_Concrete_Test is Base_Test {
    ...
    function setUp() public virtual override {
        ...
        layerZeroV2Config = _deployLayerZeroV2Config(dao, address(accessManager));

        _setupLayerZeroV2ConfigAMFunctionRoles(address(accessManager), address(layerZeroV2Config));
